...
# 版本：v3.2 · 基准：master@0c29f7c8

# 全仓 87,600 行 · 净生产代码 52,200（ex-契约 ex-迁移）
...
═══════════════════════════════════════════════
§2 当前状态快照（@0c29f7c8 · 实测）
═══════════════════════════════════════════════

【LOC 四层口径】(powershell -NoProfile -File scripts/count-prod-loc.ps1, @0c29f7c8)
全仓 87,600
生产域毛值 53,257 含契约层
契约层(扣除) 1,057 backend/src/schemas 8 文件
迁移(单列观测) 447 migrations/*.sql 只增不减
净生产代码 52,200 ← G-1 门禁口径

【G-1 门禁】硬上限 ≤55,000 · 目标 ≤52,000
距目标差 200 行（U-1 feat 净增后）；达标路径 = 待新收割侦察
...
SSR−344 A4+17 A5+46 B3+39 a11y+21 U-1+67 → 净 −215【全部实测】

G-1 即时状态：52,200，距 ≤52,000 差 200 行
