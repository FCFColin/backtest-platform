...
function ComparisonTable() {
  return (
    <div style={{ marginTop: 16 }}>
      <div
        style={{ fontSize: 16, fontWeight: 700, color: 'var(--text-strong)', marginBottom: 12 }}
      >
        功能限额对比
      </div>
...
function CompareTh({
  ...
  return (
    <th style={{ textAlign: align as React.CSSProperties['textAlign'], padding: '10px 12px', color, fontWeight: weight }}>
      {text}
    </th>
  );
}
