  ...
  return (
    <>
      <label style={fieldWrap}>
        ...
        <input type="text" value={username} onChange={(e) => setUsername(e.target.value)} autoComplete="username" required className="portfolio-rebalance-select" style={{ width: '100%', height: 40 }} />
      </label>
      <label style={fieldWrap}>
        <span style={fieldLabel}>邮箱</span>
        <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} autoComplete="email" required className="portfolio-rebalance-select" style={{ width: '100%', height: 40 }} />
      </label>
      <label style={fieldWrap}>
        <span style={fieldLabel}>密码（至少 8 位）</span>
        <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} autoComplete="new-password" required minLength={8} className="portfolio-rebalance-select" style={{ width: '100%', height: 40 }} />
      </label>
      <label style={fieldWrap}>
        <span style={fieldLabel}>组织名称</span>
        <input type="text" value={orgName} onChange={(e) => setOrgName(e.target.value)} required className="portfolio-rebalance-select" style={{ width: '100%', height: 40 }} />
      </label>
    </>
  );
}
