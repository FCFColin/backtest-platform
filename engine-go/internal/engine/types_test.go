...
var expectedStatisticsFields = []string{
	"cagr", "mwrr", "totalReturn", "bestYear", "worstYear",
	...
	"sharpe", "sortino", "calmar", "ulcerPerformanceIndex", "diversificationRatio",
	"alpha", "beta", "rSquared", "benchmarkCorrelation",
	"upsideCorrelation", "downsideCorrelation",
	"upsideCapture", "downsideCapture", "upsideCaptureAnnual", "downsideCaptureAnnual",
	"trackingError", "informationRatio",
	"var", "cvar",
	"skewness", "excessKurtosis",
	"winRate", "pctPositiveDays", "pctPositiveMonths",
