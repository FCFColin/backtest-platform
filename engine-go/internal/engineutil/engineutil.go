...
func ParseTradingDates(priceData map[string]map[string]float64) []time.Time {
	...
	return slices.SortedFunc(maps.Keys(dateSet), func(a, b time.Time) int { return a.Compare(b) })
}
