...
| 15001 | 后端 API              | 内网(nginx ingress 代理) | 5432  | PostgreSQL  | 内网(TLS, 生产强制)  |
| 15004 | Go 引擎               | 内网                     | 6379  | Redis       | 内网(rediss: 需 TLS) |
...
配置: 50% 失败率 Open, HalfOpen 探测间隔: 引擎 30s、PostgreSQL 10s。
