...
- FORCE RLS: backtest_app 不得 BYPASSRLS（迁移 001；003 增加 platform-admin 逃逸）
- 不启用 RLS: tickers, prices, cpi_data, exchange_rates, outbox（有意为之）；audit_logs/webhook/billing 表 ENABLE RLS 但非 FORCE（保留 platform-admin 逃逸）
