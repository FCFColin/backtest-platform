...
- [x] Phase 1: 测试基础设施抽取
  ...
  - [ ] 1.10-1.12: 中间件测试迁移、logger mock 迁移（部分完成）
- [x] Phase 2: 测试文件命名统一
