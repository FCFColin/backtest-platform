...
var ( httpClient *httpclient.Client; breaker = provider.NewProviderBreaker("twelvedata", 3) )
func init() {
...
if msg == "" { msg = "unknown error" }
		...
		if resp.Status != "ok" { return nil, fmt.Errorf("Twelve Data API 异常状态: %s", resp.Status) }
