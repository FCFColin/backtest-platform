...
export const TABLE_COLUMNS: Column<OptimizeResultItem>[] = [
  {
    ...
    render: (r) => (r.rebalanceFrequency === 'threshold' ? i18n.t('params.thresholdWithValue', { value: r.rebalanceThreshold }) : (REBALANCE_LABELS[r.rebalanceFrequency] ?? r.rebalanceFrequency))
  },
  {
