...
import {
  ...
  getCorrelationColor,
  SECTION_TITLE_STYLE,
  FRONTIER_TOOLTIP_STYLE,
} from './utils.js';
import { REBALANCE_LABELS } from './types.js';
import type { FrontierResultsProps, ReturnObjective, FrontierSolver } from './types.js';
...
export default FrontierResults;
export {
  FrontierResults,
  FrontierScatterChart,
  FrontierAllocations,
