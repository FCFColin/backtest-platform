...
export const COMPUTE_PAGES: PageAdapter[] = [
  ...
  },
  {
    ...
    fill: async (page, rng) => {
      await fillDateRange(page, rng, ['#pca-start-date', '#pca-end-date']);
    },
  },
  {
    name: '因子回归',
    ...
    fill: async (page, rng) => {
      await fillPortfolioEditor(page, rng);
      await fillDateRange(page, rng, ['#fr-start-date', '#fr-end-date']);
    },
  },
  {
    name: '战术分配',
    ...
    fill: async (page, rng) => {
      ...
      await fillDateRange(page, rng, ['#tactical-start-date', '#tactical-end-date']);
    },
  },
  {
    name: '杠杆 ETF 滑点',
    ...
    fill: async (page, rng) => {
      await fillPlainInput(page, rng, /如 TQQQ|e\.g\. TQQQ/);
      await fillPlainInput(page, rng, /如 QQQ|e\.g\. QQQ/);
      await fillDateRange(page, rng, 'generic');
    },
  },
  {
  ...
  },
  {
    ...
    fill: async (page, rng) => {
      await fillPortfolioEditor(page, rng);
      await fillDateRange(page, rng, ['#bp-start-date', '#bp-end-date']);
    },
  },
  {
    name: '再平衡敏感性',
  ...
  },
  {
    ...
    fill: async (page, rng) => {
      await fillPlainInput(page, rng, /如 SPY|e\.g\. SPY/);
      await fillDateRange(page, rng, 'generic');
    },
  },
  {
