...
describe('Bug Hunt - 偏离调仓对小权重过度敏感', () => {
  it('目标权重1%的仓位，实际2%，相对偏差=100%，立即触发调仓', () => {
    ...
    const priceData: PriceData = {
      BIG: makeLinearPriceData('BIG', '2020-01-02', '2020-12-31', 100, 0.002),
      SMALL: makeLinearPriceData('SMALL', '2020-01-02', '2020-12-31', 100, 0.001),
    };
    const portfolio: Portfolio = {
      id: 'p1',
      name: 'Test',
  ...
  it('目标权重-1%的做空仓位，相对偏差计算是否正确', () => {
    ...
    const priceData: PriceData = {
      LONG: makeLinearPriceData('LONG', '2020-01-02', '2020-12-31', 100, 0.001),
      SHORT: makeLinearPriceData('SHORT', '2020-01-02', '2020-12-31', 100, -0.001),
    };
    const portfolio: Portfolio = {
      id: 'p1',
      name: 'Test',
...
describe('Bug Hunt - 日期边界', () => {
  it('startDate = endDate，只有1天数据', () => {
    const priceData: PriceData = {
      A: makeLinearPriceData('A', '2020-01-02', '2020-01-02', 100, 0),
    };
    const portfolio: Portfolio = {
      id: 'p1',
      name: 'Test',
