...
async function capture() {
  ...
  try {
    ...
    if (clicked) {
      ...
      await page.screenshot({ path: 'd:/Project/回测平台/.trae/specs/local-v3-dark-v2.png', fullPage: true });
    ...
    await page.screenshot({ path: 'd:/Project/回测平台/.trae/specs/testfolio-ref-dark-v2.png', fullPage: true });
