...
const skip =
  /node_modules|dist|coverage|\.git|\.turbo|\.nyc_output|lcov-report|\.dev-logs|pnpm-lock/;
...
for (const file of files) {
  ...
  if (output !== original) {
    ...
    if (filesChanged % 50 === 0)
      console.log(`  ${filesChanged} files, ${totalRemoved} lines removed...`);
  }
}
