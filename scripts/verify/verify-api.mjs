...
import { fileExists, readFileContent, writeAggregatedResult } from './_lib.mjs';
...
try {
  ...
  if (!fileExists(C023_targetFile)) {
    results['C-023'] = { status: 'FAIL', summary: `${C023_targetFile} 不存在` };
  } else {
...
writeAggregatedResult('verify-api', results);
process.exit(0);
